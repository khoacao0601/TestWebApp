            ...
            <div className="col-md-4 col-sm-11 col-xs-11">
              <div className="footer-text pull-left">
                <div className="d-flex">
                  <h1 className="font-weight-bold mr-2 px-3" style={{ color: '#16151a', backgroundColor: '#957bda' }}> KA </h1>
                ...
                <div className="social mt-2 mb-3">
                  ...
                  <i className="fab fa-instagram-square fa-10x"></i>
          ...
          <div className="row" style={{ fontSize: '10px' }}>
            <div className="col-md-6 col-sm-6 col-xs-6">
              <div className="pull-left">
                <p><i className="fa fa-copyright"></i> 2020 Khoa Cao</p>
              </div>
            </div>
            <div className="col-md-6 col-sm-6 col-xs-6">
